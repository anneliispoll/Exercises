...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        vocabulary.put("PÕHI","N");
        vocabulary.put("LÕUNA","S");
        vocabulary.put("IDA","E");
        vocabulary.put("LÄÄS","W");
        vocabulary.put("VÄLJAPÄÄS","Q");
        ...
        while (true){
            ...
            if (exits.containsKey(direction)){
                ...
                System.out.println("Walking to next location");
                for (int i = 0; i < 6; i++) {
                    System.out.print(".");
